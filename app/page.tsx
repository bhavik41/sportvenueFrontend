...
export default function HomePage() {
  ...
  return (
    <main
      id="main-content"
      className="flex-1 relative h-full overflow-y-hidden"
    >
      <div id="RolloutPageContent">
        <div id="root">
          <section
            id="hero"
            className="relative min-h-screen bg-gradient-to-br px-4 sm:px-6 md:px-12 lg:px-24 from-gray-900 via-gray-800 to-indigo-900 overflow-hidden bg-[url('https://images.unsplash.com/photo-1599474924187-334a4ae5bd3c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w2MzQ2fDB8MXxzZWFyY2h8MXx8c3BvcnRzJTI1MjB2ZW51ZSUyNTIwYm9va2luZyUyNTIwbW9kZXJuJTI1MjBwcm9mZXNzaW9uYWwlMjUyMGJyaWdodHxlbnwxfDB8fHwxNzQ5NDYwNzYxfDA&ixlib=rb-4.1.0&q=80&w=1080')] bg-cover bg-center"
          >
            <div className="absolute inset-0 bg-gradient-to-br  from-black/40 via-gray-900/70 to-transparent"></div>

            <div className="absolute inset-0 overflow-hidden w-full h-full">
              <div className="absolute top-10 sm:top-20 left-4 sm:left-10 w-16 sm:w-32 h-16 sm:h-32 bg-white/5 rounded-full animate-pulse"></div>
              <div className="absolute top-10 sm:top-20 right-4 sm:right-20 w-12 sm:w-24 h-12 sm:h-24 bg-blue-400/10 rounded-full animate-bounce"></div>
              <div className="absolute bottom-16 sm:bottom-32 left-1/4 w-8 sm:w-16 h-8 sm:h-16 bg-indigo-400/15 rounded-full animate-ping"></div>
            </div>
            <nav className="relative z-20 flex items-center justify-between px-6 py-4 mx-auto sm:px-10 lg:px-12 ">
              ...
              <div className="hidden md:flex items-center gap-0 ">
                <a
                  href="#hero"
                  className="flex items-center px-5 py-1 rounded-lg text-white hover:bg-white hover:text-black transition transform-3d"
                >
                  Home
                </a>
                <a
                ...
                <button
                  ...
                  className="bg-white text-blue-900 px-6 py-2 rounded-lg font-semibold hover:bg-blue-50 transition-colors duration-300 ease-in-out"
                >
                  Get Started
                </button>
              </div>
              ...
              <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
                <div className="text-white space-y-6 sm:space-y-8 text-center lg:text-left">
                  <div className="space-y-4">
                    ...
                    <p className="text-lg sm:text-xl text-white/80 max-w-lg mx-auto lg:mx-0">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <button
                      ...
                      className="border-2 border-white/30 text-white px-8 py-4 rounded-lg font-semibold hover:bg-white/10 transition-all backdrop-blur-sm"
                    >
                      List Your Venue
                    </button>
                  </div>
                ...
                <div className="space-y-4 sm:space-y-6 flex flex-col max-w-lg items-center lg:items-end w-full lg:w-auto">
          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
              ...
              <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
                <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-6 sm:p-8 animate-fade-in-up">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 sm:p-8 md:p-12">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
              ...
              <div className="relative">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 relative z-10">
                  ...
                  <div className="text-center group">
                    <div className="relative mb-8">
                      <div className="w-24 h-24 sm:w-32 sm:h-32 mx-auto rounded-2xl overflow-hidden shadow-lg group-hover:shadow-xl transition-all duration-300">
                        <img
                      ...
                      <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-sm sm:text-lg shadow-lg">
                        3
                      </div>
                    </div>
              ...
              <div className="mt-12 sm:mt-20 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12">
          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
              <div className="text-center mb-12 sm:mb-16">
                <div className="inline-flex items-center bg-blue-100 text-blue-800 px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-medium mb-4">
                  <svg
                ...
                <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group">
                  <div className="p-6 sm:p-8">
                    <div className="flex items-center mb-6">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl flex items-center justify-center mr-4">
                        <svg
                          className="w-6 h-6 sm:w-8 sm:h-8 text-white"
                          fill="currentColor"
                          viewBox="0 0 20 20"
          ...
          <section
            id="testimonials"
            className="py-12 sm:py-16 bg-gradient-to-br from-blue-50 to-indigo-100"
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
                <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
                  <div className="flex items-center mb-4">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold text-sm sm:text-lg">
                      R
                    </div>
              ...
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-white text-center">
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center text-lg sm:text-2xl font-bold mr-3 sm:mr-4">
                      V
                    </div>
